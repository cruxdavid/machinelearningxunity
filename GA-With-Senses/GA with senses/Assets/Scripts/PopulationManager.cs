...
public class PopulationManager : MonoBehaviour {
    ...
    private void Start () {
        for ( int i = 0; i < populationSize; i++ ) {
            Vector3 startingPos = GetStartingPos ();
    ...
    Vector3 GetStartingPos () {
        return new Vector3 ( transform.position.x + Random.Range ( -2 , 2 ) , transform.position.y , transform.position.z + Random.Range ( -2 , 2 ) );
    }
}
